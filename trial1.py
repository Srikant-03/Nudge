...
# Blink and yawn detection setup
EYE_AR_THRESH = 0.3
EYE_AR_CONSEC_FRAMES = 2
YAWN_AR_THRESH = 25  # Threshold for yawn detection
...
while True:
    ...
    cv2.putText(frame, f"Yawn Count: {yawn_count}", (10, 230), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
